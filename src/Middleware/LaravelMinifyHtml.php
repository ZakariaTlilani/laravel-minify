...
namespace zakariatlilani\LaravelMinify\Middleware;

use Closure;
use Illuminate\Http\Response;
use Illuminate\Support\Facades\App;
use Illuminate\Support\Facades\Config;
use zakariatlilani\LaravelMinify\LaravelMinifyFacade;
...
class LaravelMinifyHtml
{
	...
	public function handle($request, Closure $next): mixed
	{
		...
		if (
			...
			&& (Config::get('htmlminify.only_production') === (env('APP_ENV') == 'production'))
			...
			$response->setContent(LaravelMinifyFacade::htmlMinify($response->getContent()));
		}
